...
workflow smrtcells_trial {
  ...
  output {
    ...
    Array[String] affected_persons_sample_names            = if defined(smrtcells_affected_person.sample_names)     then smrtcells_affected_person.sample_names      else []
    ...
    Array[String] unaffected_persons_sample_names         = if defined(smrtcells_unaffected_person.sample_names)   then smrtcells_unaffected_person.sample_names    else []
  }
}
